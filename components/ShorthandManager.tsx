...
export default function ShorthandManager() {
    ...
    const handleShorthandInputChange = (inputEvent: any) => {
        ...
        const spaceReplace = "-";
        var updatedShorthand = inputEvent?.target?.value?.replace(spaceRegex, spaceReplace);
                        ...
                        <div className="dialog-content-body my-2 grid grid-cols-1 gap-4">
                            ...
                            <div className="flex flex-col items-start justify-start gap-3">
                                ...
                                <Input 
                                    ...
                                    placeholder={`Enter content for ${shorthandInput ? "/" + shorthandInput : "shorthand"}`}
                    ...
                    {shorthandCommands?.length > 0
                        ? shorthandCommands?.map((command: ShorthandCommandType, commandIndex) => (
                            <li className="shorthand-command-item select-none" key={commandIndex}>
                                <div className="shorthand-command-item-content-wrapper rounded border bg-gray-50 border-gray-200 w-[200px] px-4 py-2 flex flex-col items-start
                                    hover:shadow
                                ">
